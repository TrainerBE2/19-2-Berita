    ...
    <div className="w-full h-[240px] text-white">
      ...
      <div className="w-[85%] mx-auto pt-[2.3rem] pb-2 ">
        <div className="w-[60%]">
          <h1 className="text-3xl mb-4">
            Berlangganan pada{" "}
            <span className="text-[#fc444a]">Portal Berita</span> kami untuk{" "}
            <span className="text-[#fc444a]">update terbaru!</span>{" "}
          </h1>
          <input
            className="bg-black border-b mr-2 border-b-white outline-none text-2xl text-gray-400 my-4 w-[140%] sm:w-[50%]"
            type="email"
            placeholder="Email"
          />
          <br></br>
          <button
            type="submit"
            className="my-3 uppercase text-xl font-light border p-1 hover:text-[#fc444a] hover:border-[#fc444a]"
          >
            Berlangganan
          </button>
        </div>
      ...
      <footer className="text-center text-white bg-black mt-3 mb-[1.3rem]">
        ...
        <p className="text-center font-thin text-slate-500">
          &#169; Dibuat dan didevelop oleh
          <a
            href="https://github.com/TrainerBE2/19-2-Berita"
            target="_blank"
            className="text-[#fc444a]"
          >
            {" "}
            Group 19-2 Berita.
          </a>

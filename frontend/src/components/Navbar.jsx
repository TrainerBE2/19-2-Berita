...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed sm:w-[30%] w-[60%] h-full bg-white z-[1000] flex items-center justify-start px-3 py-8 ${
...
// https://web.facebook.com/fitriarahma.tatik
// https://www.linkedin.com/in/mahmud-fadlan-6491192b4/
// https://web.facebook.com/profile.php?id=100076590711900
